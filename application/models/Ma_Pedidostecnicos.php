...
class Ma_Pedidostecnicos extends CI_Model {
    ...
    public function getList($postData=null){
         ...
         foreach($records as $record ){
          ...
          $base_url = base_url();
             ...
             $button .=' <a href="'.$base_url.'Cma_pedidotecnico/update_form/'.$record->id.'" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title=" Ingresar "><i class="fa fa-eye" aria-hidden="true"></i></a>';

             $button .=' <a href="'.$base_url.'Cma_pedidotecnico/print/'.$record->id.'" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="right" title=" Imprimir " target="_blank" ><i class="ti-printer" aria-hidden="true"></i></a>';
    ...
    public function impresion_cabecera($id) {
        $this->db->select('cp.codigo as codigo, DATE_FORMAT(cp.fecha, "%d-%m-%Y") as fecha_formateada');
