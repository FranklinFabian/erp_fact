...
class Anticipos extends Core
{
  public function __construct()
  {
    parent::__construct();
    $this->breadcrumb->add('Anticipos', base_url('rrhh/anticipos'));
  }
  ...
  public function index()
  {
    ...
    $content = $this->parser->parse('rrhh/anticipos/index', $data, true);
  ...
  public function reporte()
  {
    ...
    $titulo = 'PLANILLA DE DESCUENTO ANTICIPOS';
    $nombre_archivo = 'Anticipos ' . MONTH_NAMES[$mes] . '-' . $anio;

    $data_registros_mensuales   = $this->rrhhModel->getRegistrosMensualesByTablaRangoFechas('rrhh_empleado_anticipos', $mes_ini, $mes_fin);
  ...
  {
    $nombre_tabla = 'rrhh_empleado_anticipos';
