...
class Sindicato extends Core
{
  public function __construct()
  {
    parent::__construct();
    $this->breadcrumb->add('Sindicato', base_url('rrhh/sindicato'));
  }
  ...
  public function index()
  {
    ...
    $content = $this->parser->parse('rrhh/sindicato/index', $data, true);
  ...
  public function reporte()
  {
    ...
    $titulo = 'PLANILLA DE DESCUENTO SINDICATO';
    $nombre_archivo = 'Sindicato ' . MONTH_NAMES[$mes] . '-' . $anio;

    $data_registros_mensuales   = $this->rrhhModel->getRegistrosMensualesByTablaRangoFechas('rrhh_empleado_sindicato', $mes_ini, $mes_fin);
  ...
  {
    $nombre_tabla = 'rrhh_empleado_sindicato';
