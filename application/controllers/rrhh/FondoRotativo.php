...
class FondoRotativo extends Core
{
  public function __construct()
  {
    parent::__construct();
    $this->breadcrumb->add('Fondo Rotativo', base_url('rrhh/fondoRotativo'));
  }
  ...
  public function index()
  {
    ...
    $content = $this->parser->parse('rrhh/fondos_rotativos/index', $data, true);
  ...
  public function reporte()
  {
    ...
    $titulo = 'PLANILLA DE DESCUENTO FONDO ROTATIVO';
    $nombre_archivo = 'Fondo Rotativo ' . MONTH_NAMES[$mes] . '-' . $anio;

    $data_registros_mensuales   = $this->rrhhModel->getRegistrosMensualesByTablaRangoFechas('rrhh_empleado_fondo_rotativo', $mes_ini, $mes_fin);
  ...
  {
    $nombre_tabla = 'rrhh_empleado_fondo_rotativo';
