...
<div class="printableArea" id="printableArea">
    ...
    <div class="firts_section" style="">
        ...
        <div class="first_section_right"  style="width: 28%; display: inline-block;">
            ...
            <address> 
                <strong style="font-size: 20px; "><?php echo $customer_info->customer_name; ?> </strong><br>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($invoice_detail as $service) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: right; "><?php echo $service['qty']; ?></td>
                                                ...
                                                ?>
                                                 <tr>
                                            <td style="text-align: right; " colspan="2" style="border: 0px"><b><?php echo display('grand_total') ?>:</b></td>
                                            <!--<td style="border: 0px"></td>-->
                                            <td style="text-align: right; "  style="border: 0px"><b><?php echo $subTotal_quantity;?></b></td>
                                            <td style="border: 0px"></td>
                                            <td style="border: 0px"></td>
                                            <td   style="border: 0px;text-align: right;"><b><?php echo (($position == 0) ? "$currency $subTotal_ammount" : "$subTotal_ammount $currency") ?></b></td>
                                        </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="table-responsive m-b-20">
                                        ...
                                        if ($invoice_detail[0]['total_discount'] != 0) {
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right" style="border-top: 0; border-bottom: 0;text-align: right;"><?php echo (($position == 0) ? "$currency $total_discount" : "$total_discount $currency") ?> </th>
                                            </tr>
                                            <?php
                                        }
                                        if ($invoice_detail[0]['total_tax'] != 0) {
                                            ...
                                            <tr>
                                                ...
                                                <th  class="text-right" style="border-top: 0; border-bottom: 0;text-align: right;"><?php echo (($position == 0) ? "$currency $total_tax" : "$total_tax $currency") ?> </th>
                                            </tr>
                                        <?php } ?>
                                         <?php if ($invoice_detail[0]['shipping_cost'] != 0) {
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right" style="border-top: 0; border-bottom: 0;text-align: right;"><?php echo (($position == 0) ? "$currency $shipping_cost" : "$shipping_cost $currency") ?> </th>
                                            </tr>
                                        <?php } ?>
                                        <tr>
                                            <th style="text-align: right; "><?php echo display('previous'); ?> :</th>
                                            <th style="text-align: right; "><?php echo (($position == 0) ? "$currency $previous" : "$previous $currency") ?></th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: right; "><?php echo display('grand_total') ?> :</th>
                                            <th style="text-align: right; "><?php echo (($position == 0) ? "$currency $total_amount" : "$total_amount $currency") ?></th>
                                        </tr>
                                        <tr>
                                            <th class="text-left grand_total" style="border-top: 0; border-bottom: 0;text-align: right;"><?php echo display('paid_ammount') ?> : </th>
                                            <th class="text-right grand_total" style="border-top: 0; border-bottom: 0;text-align: right;"><?php echo (($position == 0) ? "$currency $paid_amount" : "$paid_amount $currency") ?></th>
                                        </tr>                
                                        <?php
                                        if ($invoice_detail[0]['due_amount'] != 0) {
                                            ...
                                            <tr>
                                                ...
                                                <th  style="text-align: right; "><?php echo (($position == 0) ? "$currency $due_amount" : "$due_amount $currency") ?></th>
                                            </tr>
                                            <?php
                                        }
                                        ?>
