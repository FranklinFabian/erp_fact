        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cmactivos_grupo/update', array('class' => 'form-vertical', 'id' => 'update')) ?>
                    <div class="panel-body">

                        <div class="form-group row">
                            <label for="id_servicio" class="col-sm-3 col-form-div"> Servicio <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <?php echo form_dropdown('id_servicio', $servicios, $id_servicio,'class="form-control" style="width:100%"') ?>
                            </div>
                        </div>
