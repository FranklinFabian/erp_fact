...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Editar tipo de responsable</h1>
            <small>Editar tipo de responsable</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i>Hogar</a></li>
                <li><a href="#">Tipo de Responsable</a></li>
                <li class="active">Editar tipo de responsable</li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Editar tipo responsable</h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Cmactivos_tipo_responsable/update', array('class' => 'form-vertical', 'id' => 'update')) ?>
