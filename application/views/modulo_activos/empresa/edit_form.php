        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cmactivos_empresa/update', array('class' => 'form-vertical', 'id' => 'update')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="abreviatura" id="abreviatura" type="text" placeholder="Abreviatura" value="{abreviatura}">
                            </div>
                        </div>
