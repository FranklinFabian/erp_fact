...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-danger alert-dismissible fade in" id="almsg" role="alert" style="display: none"> No Available Qty ..
                ...
                <div class="panel panel-bd lobidrag">
                            ...
                            <table class="table table-bordered table-hover" id="addinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <th class="text-center" style="width: 150px"><?php echo display('total') ?></th>
                    ...
                    <tr>
                                ...
                                <td class="text-right">
                                 ...
                                 <td><a  class="toggle btn btn-warning">
                <i class="fa fa-angle-double-down"></i>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td style="text-align:right;" colspan="6"><b><?php echo display('change') ?>:</b></td>
                                    <td class="text-right">
