      ...
      <a href="#" class="client-add-btn btn btn-success" aria-hidden="true" data-toggle="modal" data-target="#cust_info"><i class="ti-plus m-r-2"></i></a>
          ...
          <div class="table-responsive" style="margin-top: 10px">
                            <table class="table table-bordered table-hover table-sm nowrap gui-products-table" id="addinvoice">
                                <thead>
                                    <tr>
                                        <th class="text-center" style="width: 200px"><?php echo display('item_information') ?> <i class="text-danger">*</i></th>
                                        <th class="text-center" style="width: 100px"><?php echo display('serial') ?></th>
                        ...
                        <div class="footer">
                               ...
                               <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo $taxfldt['tax_name'] ?>:</label><div class="col-sm-5">    <input id="total_tax_ammount<?php echo $x;?>" tabindex="-1" class="form-control gui-foot text-right valid totalTax" name="total_tax<?php echo $x;?>" value="0.00" readonly="readonly" aria-invalid="false" type="text">
                            ...
                            <?php $x++;}?>
                                    ...
                                    <div class="form-group row" style="margin-bottom:5px;">
                                            <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo 'Shipping Cost' ?>:</label><div class="col-sm-5">  <input type="text" id="shipping_cost" class="form-control gui-foot text-right" name="shipping_cost" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);"  placeholder="0.00"  /></div></div>
