                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="cod_centro" id="cod_centro" type="text" placeholder="Cod. Centro" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="kva_centro" id="kva_centro" type="number" placeholder="kVA Centro" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="rel_transfo" id="rel_transfo" type="text" placeholder="Relaci&oacute;n de Transformaci&oacute;n " min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="posicion_tap" class="col-sm-2 col-form-label">Posici&oacute;n TAP :<i class="text-danger">*</i></label>
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="posicion_tap" id="posicion_tap" type="number" placeholder="Posici&oacute;n TAP" min="0" tabindex="3">
                                        </div>
                                        <label for="consumidores_mt" class="col-sm-2 col-form-label">Consumidores MT :<i class="text-danger">*</i></label>
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="consumidores_mt" id="consumidores_mt" type="number" placeholder="Consumidores MT" min="0" tabindex="3">
                                        </div>
                                        <label for="consumidores_bt" class="col-sm-2 col-form-label">Consumidores BT :<i class="text-danger">*</i></label>
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="consumidores_bt" id="consumidores_bt" type="number" placeholder="Consumidores BT" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group">
...
function GuardarRegistro(obj){
    ...
    var correcto = true;
      ...
      if(correcto==true){
        ...
        // Add record
        $.post("<?php echo base_url(); ?>odeco/registrar_centro", {
            ...
            Swal.fire(
                    {
                        icon: 'success',
                        title: 'Se registr&oacute; exitosamente el Centro',
                    }).then(function (){
            ...
            Swal.fire({
                        icon: 'error',
                        title: 'Hubo Problemas al registrar el Centro'
                        //type: 'warning'
                    }).then(function (){
                        window.location.href ="<?php echo base_url(); ?>odeco/agregar_centro";
                    });
        });
    }else{
        Swal.fire({
