...
<html lang="en" dir="ltr">
  ...
  <body style="font-family: Times New Roman, Times, serif; font-size:12px;">
    <table style="border: hidden;width: 100%">
      ...
      <tr>
        <td style="border: hidden;font-size:20px;"><strong> <?= $asunto; ?> </strong></td>
      </tr>
      <tr>
        <td style="border: hidden;font-size:12px; padding-top: 5px;"><strong> ÍNDICES INDIVIDUALES DE CONTINUIDAD DE SUMINISTRO (NIVEL DE CALIDAD: 2) </strong></td>
      </tr>
    </table>
    <br>
    <table style="border-spacing: 5px 5px;border-collapse: separate; border:0.5px;width:100%;">
      <tr>
        ...
        <td style="width:40%; border: 0.5px solid black; text-align: left;font-size:12px;">&nbsp;<?= $nombre_empresa; ?></td>
        <td style="width:20%; border: hidden;border-left: 0.5px;  text-align: right;font-size:12px;"><strong> SIGLA: </strong></td>
        <td style="width:20%; border: 0.5px solid black; text-align: center;font-size:12px;"> COOPELECT </td>
      </tr>
      <tr style="">
