                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="nro_restitucion" id="nro_restitucion" type="text" value="<?php echo $get_id_restituciones; ?>" min="0" tabindex="3" readonly="">
                                        </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_bt_1" id="consumidores_bt_1" type="number" placeholder="Consumidores Respuestos BT 1" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_bt_2" id="consumidores_bt_2" type="number" placeholder="Consumidores Respuestos BT 2" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_mt_1" id="consumidores_mt_1" type="number" placeholder="Consumidores Respuestos MT 1" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_mt_2" id="consumidores_mt_2" type="number" placeholder="Consumidores Respuestos MT 2" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="potencia_bt_1" class="col-sm-2 col-form-label">Pot. Respuesta a Consumidores en BT Calidad-1 :</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_bt_1" id="potencia_bt_1" type="number" placeholder="Pot. Respuesta a Consumidores en BT 1" min="0" tabindex="3">
                                        </div>
                                        <label for="potencia_bt_2" class="col-sm-2 col-form-label">Pot. Respuesta a Consumidores en BT Calidad-2 :</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_bt_2" id="potencia_bt_2" type="number" placeholder="Pot. Respuesta a Consumidores en BT 2" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="potencia_mt_1" class="col-sm-2 col-form-label">Pot. Respuesta a Consumidores en MT Calidad-1 :</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_mt_1" id="potencia_mt_1" type="number" placeholder="Pot. Respuesta a Consumidores en MT 1" min="0" tabindex="3">
                                        </div>
                                        <label for="potencia_mt_2" class="col-sm-2 col-form-label">Pot. Respuesta a Consumidores en MT Calidad-2 :</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_mt_2" id="potencia_mt_2" type="number" placeholder="Pot. Respuesta a Consumidores en MT 2" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group">
...
function GuardarRegistro(obj){
    ...
    var correcto = true;
      ...
      if(correcto==true){
        ...
        // Add record
        $.ajax({
            data: {nro_interrupcion,cod_proteccion,fecha_reposicion,consumidores_bt_1,consumidores_bt_2,consumidores_mt_1,consumidores_mt_2,potencia_bt_1,potencia_bt_2,potencia_mt_1,potencia_mt_2,motivo,observacion},
            url: '<?php echo base_url(); ?>odeco/registrar_restitucion',
            type: 'POST',
            dataType: 'json'
            })
        ...
        .fail(function(response)
            {
                Swal.fire({
                            ...
                            //type: 'warning'
                            window.location.href ="<?php echo base_url(); ?>odeco/agregar_restitucion";
                        });
            });
    }else{
        Swal.fire({
