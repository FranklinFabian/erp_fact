...
<html lang="es" dir="ltr">
  ...
  <body style="font-family: Times New Roman, Times, serif; font-size:12px;">
    <table style="border: hidden;width: 100%">
      <tr>
        <td style="border: hidden; text-align: right;font-size:12px; "><strong> FORMULARIO - SC2</strong></td>
      </tr>
      <tr>
    ...
    <table style="border-spacing: 5px 5px; border:0.5px;width: 100%; margin-top: 5px;">
      <tr>
        ...
        <td style="width:15%; text-align: center;font-size:12px;"><strong> Valor Limite Según Reglamento </strong></td>
        <td style="width:15%; text-align: center;font-size:12px;"><strong> Valores Obtenidos en el Semestre [%] </strong></td>
        <td style="width:15%; text-align: center;font-size:12px;"><strong> Monto de Facturación (Bs) </strong></td>
        <td style="width:15%; text-align: center;font-size:12px;"><strong> Monto de la Reducción (Bs) </strong></td>
      </tr>
      <tr>
        <td style="width:8%; text-align: center;font-size:12px; padding: 10px 0px 10px 0px;"> <strong> ICF  </strong></td>
        <td style="width:25%; text-align: left;font-size:12px; padding: 10px 0px 10px 0px;"> &nbsp;Calidad de Facturación  </td>
      ...
      <tr>
        <td style="width:8%; text-align: center;font-size:12px; padding: 10px 0px 10px 0px;"> <strong>  IFE  </strong></td>
        <td style="width:25%; text-align: left;font-size:12px; padding: 10px 0px 10px 0px;"> &nbsp;Facturación Estimada </td>
        <td style="width:15%; text-align: center;font-size:12px; padding: 10px 0px 10px 0px;"> 0 </td>
        <td style="width:15%; text-align: center;font-size:12px; padding: 10px 0px 10px 0px;"> 0 </td>
        <td style="width:15%; text-align: center;font-size:12px; padding: 10px 0px 10px 0px;"> 0 </td>
        <td style="width:15%; text-align: center;font-size:12px; padding: 10px 0px 10px 0px;"> 0 </td>
    ...
    <table style="border-spacing: 5px 5px; border:0.5px;width: 100%">
      <tr>
        ...
        <td style="width:55%;">
          <table style="border-spacing: 5px 5px; border:0.5px;width: 100%">
            <tr>
              <td style="width:60%; text-align: right; padding: 5px;"><strong>Nro. Total de Facturas Emitidas: </strong></td>
              <td style="width:30%; padding: 5px;">0</td>
            </tr>
            <tr>
              <td style="width:60%; text-align: right; padding: 5px;"><strong>Nro. de Facturas Refacturadas :</strong></td>
              <td style="width:30%; padding: 5px;">0</td>
            </tr>
            <tr>
              <td style="width:60%; text-align: right; padding: 5px;"><strong>Nro. de Facturas Estimadas: </strong></td>
              <td style="width:30%; padding: 5px;">0</td>
            </tr>
          </table>
        </td>
