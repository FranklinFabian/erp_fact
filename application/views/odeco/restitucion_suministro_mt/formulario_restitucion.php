    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <div class="header-title">
                ...
                <small>Agregar Restituci&oacute;n de Suministros MT</small>
                <ol class="breadcrumb">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="hora_reposicion" id="hora_reposicion" type="time" value="<?php echo date('H:i') ?>"   required="" tabindex="1">
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    var correcto = true;
      ...
      if(correcto==true){
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>odeco/registrar_restitucion_mt',
            type: 'POST',
            dataType: 'json'
            })
