                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="fecha_respuesta" id="fecha_respuesta" type="datetime-local" value="<?php echo date('Y-m-d\TH:i') ?>" required="" tabindex="1">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fecha_solucion" class="col-sm-2 col-form-label">Fecha Soluci&oacute;n :</label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="fecha_solucion" id="fecha_solucion" type="datetime-local" value="<?php echo date('Y-m-d\TH:i') ?>"  required="" tabindex="1">
                                            <!-- <input type="text" class="form-control" name ="fecha_solucion" value="<?php echo date('Y-m-d \ H:i') ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <label class="input-group"><input name ="indicador_justificado" type="radio" tabindex="2" value="SI"> SI</label> 
                                            <label class="input-group"><input name ="indicador_justificado" type="radio" tabindex="2" value="NO"> NO</label>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() { 
        var fecha_hora_recepcion = '<?php echo ($data[0]['FECHA_HORA_REC']); ?>';
        var fecha_hora_recepcion1 = moment(fecha_hora_recepcion, "YYY-MM-DD HH:mm");

        var fecha_hora_actual = moment().format();
        var fecha_hora_actual1 = moment(fecha_hora_actual, "YYY-MM-DD HH:mm");
        ...
        var tiempo_tramite = diferencia +' horas '+diferencia1+' minutos';
        $('#tiempo_tramite').val(tiempo_tramite);
        //para la base de datos
        var aux = diferencia1.toString().padStart(2,'0');
        //console.log(aux);
        var difer_total = parseFloat(diferencia +'.'+aux).toFixed(2);

        $('#tiempo_tramite_hidden').val(difer_total);
...
/*    function CalcularTiempo(){
        ...
        var fecha_hora_recepcion = '<?php echo($data[0]['FECHA_HORA_REC']); ?>';
        var fecha_hora_respuesta = $('#fecha_respuesta').val();
        //console.log(fecha_hora_recepcion);
        //console.log(fecha_hora_respuesta);

        var fecha_hora_recepcion1 = moment(fecha_hora_recepcion, "YYY-MM-DD HH:mm");
        var fecha_hora_actual = moment().format();
        //console.log(fecha_hora_actual);
        var fecha_hora_actual1 = moment(fecha_hora_actual, "YYY-MM-DD HH:mm");
        var fecha_hora_respuesta2 = moment(fecha_hora_respuesta, "YYY-MM-DD HH:mm");
        console.log(fecha_hora_actual1);
        console.log(fecha_hora_respuesta2);
        var diferencia = fecha_hora_actual1.diff(fecha_hora_recepcion1,'h')//diff en horas
        var minutos = diferencia*60;
        var diferencia1 = fecha_hora_actual1.diff(fecha_hora_recepcion1,'m')-minutos // diferencia minutos
        ...
        $('#tiempo_tramite').val(tiempo_tramite);
        //para la base de datos
        $('#tiempo_tramite_hidden').val(diferencia+'.'+diferencia1);
        //console.log(tiempo_tramite);
    }*/
