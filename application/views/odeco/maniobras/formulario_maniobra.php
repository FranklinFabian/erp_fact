                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                         <li class="active"><a href="#"><i class="fa fa-plus"> </i> GENERAR REGISTRO DE NUEVO ELEMENTO DE MANIOBRA</a></li>   
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="kva_proteccion" id="kva_proteccion" type="number" placeholder="kVA Protecci&oacute;n" min="0" tabindex="3">
                                        </div>
                                        <label for="kv_proteccion" class="col-sm-2 col-form-label">kV Protecci&oacute;n :<i class="text-danger">*</i></label>
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="kv_proteccion" id="kv_proteccion" type="number" placeholder="kV Protecci&oacute;n" min="0" tabindex="3">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="proteccion_superior" id="proteccion_superior" type="text" placeholder="Protecci&oacute;n Superior" min="0" tabindex="3">
                                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="submit" id="add-customer" class="btn btn-primary btn-block" name="add-customer" value="Guardar Elemento de Maniobra" onclick="GuardarRegistro(event);" tabindex="7"/>
...
function GuardarRegistro(obj){
    ...
    var correcto = true;
      if(!campoVacio($('#cod_proteccion')) || !campoVacio($("select[name='cod_alimentador']")) || !campoVacio($("select[name='tipo_proteccion']")) || !campoVacio($("select[name='estado']")) || !campoVacio($('#kva_proteccion'))|| !campoVacio($("select[name='cod_zona']")) || !campoVacio($('#consum_mt_nc1')) || !campoVacio($('#consum_mt_nc2')) || !campoVacio($('#consum_bt_nc1')) || !campoVacio($('#consum_bt_nc2')) || !campoVacio($('#direccion')))
         correcto = false;
      if(correcto==true){
        ...
        // Add record
        $.post("<?php echo base_url(); ?>odeco/registrar_maniobra", {
            ...
            Swal.fire(
                    {
                        icon: 'success',
                        title: 'Se registr&oacute; exitosamente el Elemento de Maniobra',
                    }).then(function (){
            ...
            Swal.fire({
                        icon: 'error',
                        title: 'Hubo Problemas al registrar el Elemento de Maniobra'
                        //type: 'warning'
                    }).then(function (){
                        window.location.href ="<?php echo base_url(); ?>odeco/agregar_maniobra";
                    });
        });
    }else{
        Swal.fire({
