                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                         <li class="active"><a href="#"><i class="fa fa-plus"> </i> EDITAR REGISTRO</a></li>   
                    ...
                    <div class="panel-body">
                                <div class="col-md-9 col-md-offset-2">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="descripcion" id="descripcion" type="text" value="<?= ($data[0]['DESCRIPCION']); ?>" tabindex="1" placeholder="Describa el dia feriado">
                                        </div>
                                        <label for="fecha" class="col-sm-2 col-form-label">Fecha Feriado:</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" name ="fecha" id="fecha" type="date" value="<?= date('Y-m-d',strtotime($data[0]['FECHA'])); ?>"  required="" tabindex="1">
                                        </div>
                                    </div>
                                </div>
...
function GuardarRegistro(obj){
    ...
    var correcto = true;
      ...
      if(correcto==true){
        ...
        var fecha = $("#fecha").val();
        var id_feriado = '<?= ($data[0]['ID_FERIADO']); ?>';
        // Add record
        $.ajax({
            data: {descripcion,fecha, id_feriado},
            url: '<?php echo base_url(); ?>odeco/modificar_feriado',
            type: 'POST',
            dataType: 'json'
            })
