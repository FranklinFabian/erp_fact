                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="nro_programado" id="nro_programado" type="text" value="<?= ($data[0]['NRO_INTERRUPCION']); ?>" min="0" tabindex="3" readonly="">
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" name="nro_diario" id="nro_diario" tabindex="5">
                                                <option value="<?= ($data[0]['NRO_DIARIO']); ?>"><?php if($data[0]['NRO_DIARIO'] == 0){ echo 'Sin Libro Guardia'; }else{echo $data[0]['NRO_DIARIO'];} ?></option>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_bt_1" id="consumidores_bt_1" type="number" value="<?= ($data[0]['CONSUM_BT_1']); ?>" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_bt_2" id="consumidores_bt_2" type="number" value="<?= ($data[0]['CONSUM_BT_2']); ?>" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="consumidores_mt_1" class="col-sm-2 col-form-label">Consu<?= ($data[0]['CONSUM_BT_1']); ?>midores MT Calidad-1 Afectados :<i class="text-danger">*</i></label>
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_mt_1" id="consumidores_mt_1" type="number" value="<?= ($data[0]['CONSUM_MT_1']); ?>" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="consumidores_mt_2" id="consumidores_mt_2" type="number" value="<?= ($data[0]['CONSUM_MT_2']); ?>" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_bt_1" id="potencia_bt_1" type="number" value="<?= ($data[0]['KVA_BT_1']); ?>" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_bt_2" id="potencia_bt_2" type="number" value="<?= ($data[0]['KVA_BT_2']); ?>" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_mt_1" id="potencia_mt_1" type="number" value="<?= ($data[0]['KVA_MT_1']); ?>" min="0" tabindex="3">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" name ="potencia_mt_2" id="potencia_mt_2" type="number" value="<?= ($data[0]['KVA_MT_2']); ?>" min="0" tabindex="3">
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="submit" id="add-customer" class="btn btn-primary btn-block" name="add-customer" value="Modificar Registro" onclick="ModificarRegistro(event);" tabindex="7"/>
...
function ModificarRegistro(obj){
    ...
    var correcto = true;
      if(!campoVacio($("select[name='nro_diario']")) || !campoVacio($("select[name='tipo_falla']")) || !campoVacio($("select[name='cod_alimentador']")) || !campoVacio($("select[name='cod_proteccion']")) || !campoVacio($("#fecha_inicial")) || !campoVacio($("#hora_inicial")) || !campoVacio($("#fecha_final")) || !campoVacio($("#hora_final")) || !campoVacio($("select[name='origen_interrupcion']"))|| !campoVacio($("select[name='causa_interrupcion']")) || !campoVacio($("select[name='cod_tipo_origen']"))|| !campoVacio($("select[name='cod_tipo_causa']"))|| !campoVacio($("#consumidores_bt_1"))|| !campoVacio($("#consumidores_bt_2"))|| !campoVacio($("#consumidores_mt_1"))|| !campoVacio($("#consumidores_mt_2"))|| !campoVacio($("#potencia_bt_1"))|| !campoVacio($("#potencia_bt_2"))|| !campoVacio($("#potencia_mt_1"))|| !campoVacio($("#potencia_mt_2")))
         correcto = false;
      if(correcto==true){
        var nro_programado = '<?= ($data[0]['NRO_INTERRUPCION']); ?>';
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>odeco/modificar_interrupcion',
            type: 'POST',
            dataType: 'json'
            })
