    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <div class="header-title">
                ...
                <small>Agregar Libro de Guardia</small>
                <ol class="breadcrumb">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" name ="nro_diario" id="nro_diario" type="text" value="<?php echo $get_id_libro; ?>" min="0" tabindex="3" readonly="">
                                        </div>
                                        ...
                                        <select class="form-control" name="nro_programado" id="nro_programado" tabindex="5">
                                                ...
                                                <option value="Sin Corte">Sin Corte Programado</option>
                                                <!-- <option value="<?php echo $get_id_libro; ?>"><?php echo $get_id_libro; ?></option> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="submit" id="add-customer" class="btn btn-primary btn-block" name="add-customer" value="Guardar Libro de Guardia" onclick="GuardarRegistro(event);" tabindex="7"/>
    ...
    var correcto = true;
      ...
      if(correcto==true){
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>odeco/registrar_libro',
            type: 'POST',
            dataType: 'json'
            })
        .done(function(response)
            {
                Swal.fire(
                        {
                            icon: 'success',
                            title: 'Se registr&oacute; exitosamente el Libro de Guardia',
                            text: 'El Libro de Guardia fue designado con el Codigo Nro.'+response
                        }).then(function (){
        ...
        .fail(function(response)
            {
                Swal.fire({
                            icon: 'error',
                            title: 'Hubo Problemas al registrar el Libro de Guardia'
                        }).then(function (){
                            //type: 'warning'
                            window.location.href ="<?php echo base_url(); ?>odeco/agregar_libro";
                        });
            });
    }else{
        Swal.fire({
...
function CalcularTiempo(fecha_inicial, fecha_final){
        ...
        var aux = parseFloat(diferencia1.toString().padStart(2,'0'));
