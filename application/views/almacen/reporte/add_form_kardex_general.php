...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1> Reportes </h1>
            <small>Kardex general</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i>Hogar</a></li>
                <li><a href="#"> Reportes </a></li>
                <li class="active"> Kardex general </li>
            </ol>
        </div>
    </section>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="pdf" class="tab-pane fade in active">
                                <div class="row" style="padding: 50px;" align="center">
                                    <form action="kardex_general_pdf" method="POST">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="provider" class="col-sm-4 col-form-div"> Tipo: <i class="text-danger">*</i> </label>
                                                <div class="col-sm-8">
                                                    <select name="tipo" class="form-control select2_general" style="width:100%" required>
