...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small> Administra tus ordenes de compra </small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> Hogar </a></li>
                <li><a href="#"> Ordenes de Compra</a></li>
                <li class="active"> Administra tus ordenes de compra </li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
         <?php if($this->permission1->method('administrar_almacen_orden_compra','create')->access()){ ?>
             <a href="<?php echo base_url('Cma_orden_compra') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> Añadir Orden de Compra </a>
         <?php }?>
                </div>
            </div>
        </div>
    ...
    var snippet_datatable = function () {
        var initTable1 = function() {
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/Cma_orden_compra/dataList/',
                    type : 'POST'
                },
