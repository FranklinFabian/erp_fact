    ...
    <table width="100%">
        ...
        <tr>
            <td width="50%">
                ...
                <br><br><br><br><br>
                <strong>Uso ó Destino:</strong> {uso}
                <br>
                Cuenta:
                <br>
    ...
    <?php if ($detalles) { ?>
        <table width="100%">
            <tr>
                <td width="3%"></td>
                <td align="center">
                    <div style="border-top: 1px solid #000;">Gerente General</div>
                </td >
                <td width="3%"></td>
                <td align="center">
                ...
                <td width="3%"></td>
                <td align="center">
                    <div style="border-top: 1px solid #000;">Solicitante</div>
                </td>
                <td width="3%"></td>
            </tr>
        </table>
