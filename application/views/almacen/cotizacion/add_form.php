...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Añadir nueva cotización</small>
            <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    <?php if($this->permission1->method('administrar_almacen_cotizacion','read')->access()){ ?>
                        <a href="<?php echo base_url('Cma_cotizacion/administrar') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>Administrar cotización</a>
                     <?php }?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cma_cotizacion/insert', array('class' => 'form-vertical', 'id' => 'insert', 'name' => 'insert')) ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="id_proveedor" class="form-control" style="width:100%" required="">
                                            <option value=""> <?php echo display('select_provider') ?> </option>
                                            <?php if ($proveedores) { ?>
                                                {proveedores}
                            ...
                            <table class="table table-bordered table-hover"  id="table">
                                ...
                                <tbody id="item">
                                    <tr class="">
                                        ...
                                        <td class="">
                                            <input type="text" class="form-control text-right" name="costo[]" placeholder="0.00"  required  min="0"/>
                                        </td>

                                        <td class="">
                                            <input type="text" class="form-control text-right" name="cantidad[]" required  min="0"/>
                                        </td>
