...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Orden de Trabajo de edición</h1>
            <small>Edita tu orden de trabajo</small>
            <ol class="breadcrumb">
                <li><a href="index.html"><i class="pe-7s-home"></i> Hogar </a></li>
                <li><a href="#">Orden de trabajo</a></li>
                <li class="active">Orden de trabajo de edición</li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4> Orden de trabajo de edición </h4>
                                </div>
                                <div class="col-lg-6" align="right">

                                    <a href="<?php echo base_url() . 'Cma_orden_trabajo/print/' . $id; ?>" class="btn btn-info btn-md" data-toggle="tooltip" data-placement="left" title=" Imprimir " target="_blank" ><i class="ti-printer" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Cma_orden_trabajo/update', array('class' => 'form-vertical', 'id' => 'update', 'name' => 'update')) ?>
...
<script type="text/javascript">
    ...
    function loadModal(id , type){
        var idP =  $('#id').val();
        $.get( base_url + '/Cma_orden_trabajo/modal_edit/?id=' + id + '&type=' + type + '&idP=' + idP , function (data) {
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/Cma_orden_trabajo/deleteHijo/',
            type: 'POST',
            data: {id:id},
    ...
    var snippet_datatable = function () {
        ...
        var initTable1 = function() {
            ...
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/Cma_orden_trabajo/dataTable/',
                    type : 'POST',
                ...
                columns: [
                    ...
                    { data: 'total', title: 'Total', render: $.fn.dataTable.render.number('.', ',', 2, 'Bs. ') },
