<form action="<?php echo site_url('Cma_ingreso/update_datatable');?>" id="form" method="post">
            ...
            <div class="panel panel-bd lobidrag">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="costo" name="item[costo_real]" class="form-control" placeholder="Ingrese el costo unitario de ingreso" value="<?php if ( $type == 'update') { echo $item['costo_real']; }?>">
                    </div>
            ...
            $.get( base_url + '/Cma_articulo/lista/?id=' + id, function (data) {
                ...
                if (data){
                    $.each(jQuery.parseJSON(data), function () {
                        $("#id_articulo").append($("<option></option>").val(this['id']).html(this['codigo'] + ' - ' + this['nombre']));
                    });
                }
            });
        });
