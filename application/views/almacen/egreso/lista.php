...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small> Administra tus egresos </small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> Hogar </a></li>
                <li><a href="#"> Egresos </a></li>
                <li class="active"> Administra tus egresos </li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
         <?php if($this->permission1->method('administrar_almacen_egreso','create')->access()){ ?>
             <a href="<?php echo base_url('Cma_egreso') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> Añadir Egreso </a>
         <?php }?>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var snippet_datatable = function () {
        var initTable1 = function() {
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/Cma_egreso/dataList/',
                    type : 'POST'
                },
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/Cma_egreso/deletePrincipal/',
            type: 'POST',
            data: {id:id},
