...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Nuevo pedido (Técnico)</h1>
            <small>Añadir pedido (Técnico)</small>
            <ol class="breadcrumb">
                <li><a href="index.html"><i class="pe-7s-home"></i>Hogar</a></li>
                <li><a href="#">Pedido (Técnico)</a></li>
                <li class="active">Nuevo pedido (Técnico)</li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
<?php if($this->permission1->method('administrar_almacen_pedido_tecnico','read')->access()){ ?>
                    <a href="<?php echo base_url('Cma_pedidotecnico/administrar') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  Administrar los pedidos técnicos </a>
                     <?php }?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Nuevo pedido (Técnico)</h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Cma_pedidotecnico/insert', array('class' => 'form-vertical', 'id' => 'insert', 'name' => 'insert')) ?>
