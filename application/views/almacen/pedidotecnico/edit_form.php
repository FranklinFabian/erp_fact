...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Pedido (Técnico) de edición</h1>
            <small>Edita tu pedido (Técnico)</small>
            <ol class="breadcrumb">
                <li><a href="index.html"><i class="pe-7s-home"></i>Hogar</a></li>
                <li><a href="#">Pedido (Técnico)</a></li>
                <li class="active">Pedido (Técnico) de edición</li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4> Pedido tecnico de edición </h4>
                                </div>
                                <div class="col-lg-6" align="right">

                                    <a href="<?php echo base_url() . 'Cma_pedidotecnico/print/' . $id; ?>" class="btn btn-info btn-md" data-toggle="tooltip" data-placement="left" title=" Imprimir " target="_blank" ><i class="ti-printer" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Cma_pedidotecnico/update', array('class' => 'form-vertical', 'id' => 'update', 'name' => 'update')) ?>
...
<script type="text/javascript">
    ...
    function loadModal(id , type){
        var idP =  $('#id').val();
        $.get( base_url + '/Cma_pedidotecnico/modal_edit/?id=' + id + '&type=' + type + '&idP=' + idP , function (data) {
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/Cma_pedidotecnico/deleteHijo/',
            type: 'POST',
            data: {id:id},
    ...
    var snippet_datatable = function () {
        ...
        var initTable1 = function() {
            ...
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/Cma_pedidotecnico/dataTable/',
                    type : 'POST',
