  ...
  <section class="content-header">
    ...
    <div class="header-title">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo "Plantillas" ?></li>
      </ol>
    </div>
  </section>
      ...
      <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-md-12">
                <form action="<?php echo base_url('security/form?id=25') ?>" method="POST">
  ...
  async function ver_plantilla(id) {
    ...
    const plantilla_data = await $.ajax({
      ...
      error: function (error) {
        ok_alert('error', 'Error!', 'Ocurrió un error, intente nuevamente.');
      }
    });

    const html = plantilla_data.map(pd => `
      <tr>
        <td>${pd.codigo_formato} | ${pd.nombre}</td>
        <td>${pd.tipo}</td>
        <td>${pd.referencia}</td>
        <td>${pd.porcentaje} %</td>
      </tr>
