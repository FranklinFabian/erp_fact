                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-center">
                            ...
                            {/company_info}
                            <h4> <?php echo display('date') ?>:<?php echo date("d/m/Y") . "&nbsp; <span id=\"time\"></span>&nbsp;" . date(" a", time()); ?> </h4>
                        </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control text_1" name="thousands" onkeyup="calculator()"  onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_1_bal" readonly=""></td>
                                </tr> 
                                <tr>
                                    <td class="500"><?php echo display('500') ?></td>
                                    <td><input type="number" class="form-control text_2" name="fivehnd" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_2_bal" readonly=""></td>
                                </tr>   
                                <tr>
                                    <td class="100"><?php echo display('100') ?></td>
                                    <td><input type="number" class="form-control text_3" name="hundrad" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_3_bal" readonly=""></td>
                                </tr>   
                                <tr>
                                    <td class="50"><?php echo display('50') ?></td>
                                    <td><input type="number" class="form-control text_4" name="fifty" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_4_bal" readonly=""></td>
                                </tr>   
                                <tr>
                                    <td class="20"><?php echo display('20') ?></td>
                                    <td><input type="number" class="form-control text_5" name="twenty" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_5_bal" readonly=""></td>
                                </tr>   
                                <tr>
                                    <td class="10"><?php echo display('10') ?></td>
                                    <td><input type="number" class="form-control text_6" name="ten" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_6_bal" readonly=""></td>
                                </tr>   
                                <tr>
                                    <td class="5"><?php echo display('5') ?></td>
                                    <td><input type="number" class="form-control text_7" name="five" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_7_bal" readonly=""></td>
                                </tr>   
                                <tr>
                                    <td class="2"><?php echo display('2') ?></td>
                                    <td><input type="number" class="form-control text_8" name="two" onkeyup="calculator()" onchange="calculator()"></td>
                                    <td><input type="text" class="form-control text_8_bal" readonly=""></td>
                                </tr>
                                <tr>
                                    <td class="1"><?php echo display('1') ?></td>
                                    <td><input type="number" class="form-control text_9" name="one" onkeyup="calculator()" onchange="calculator()"></td>
