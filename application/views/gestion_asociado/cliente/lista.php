...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Administrar cliente</small>
            <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
         ...
         <?php if($this->permission1->method('administrar_almacen_ingreso','create')->access()){ ?>
             <a href="<?php echo base_url('Cga_cliente') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> Añadir cliente </a>
         <?php }?>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var snippet_datatable = function () {
        var initTable1 = function() {
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/Cga_cliente/dataList/',
                    type : 'POST'
                },
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/Cga_cliente/deletePrincipal/',
            type: 'POST',
            data: {id:id},
