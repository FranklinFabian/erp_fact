                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4>Añadir suscripción</h4>
                                </div>
                                <div class="col-lg-6" align="right">
                                    <a href="<?php echo base_url() . 'Cga_suscripcion/print/' . $id; ?>" class="btn btn-info btn-md" data-toggle="tooltip" data-placement="left" title=" Imprimir " target="_blank" ><i class="ti-printer" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function loadModal(id , type){
        $.get( base_url + '/Cga_suscripcion/modal_edit/?id=' + id + '&type=' + type + '&idP=' + idP , function (data) {
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/Cga_suscripcion/delete/',
            type: 'POST',
            data: {id:id},
    ...
    var snippet_datatable = function () {
        ...
        var initTable1 = function() {
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/Cga_suscripcion/dataTable/',
                    type : 'POST',
                    data: {idP:idP},
                },
