<form action="<?php echo site_url('Cga_suscripcion/update_datatable');?>" id="form" method="post">
            ...
            <div class="panel panel-bd lobidrag">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control" name="item[nota]" id="nota" rows="3" placeholder="Nota" ><?php if ($type == "update") { echo $item['nota']; } ?></textarea>
                        </div>
                    </div>
