<?php
    ...
    $nombre_reporte = ucwords(strtolower($data_control->descripcion));
$html = '
<html>
    <head>
        <title>Reporte de '.$nombre_reporte.'</title>
        <style>
            ...
            <table border="0" cellspacing="0" width="100%" id="tabla_cabecera" class="">
                <tr>
                    ...
                    <td class="textRight" width="70%">
                        <span class="tamanioTitulo bold">REPORTE DE '.$data_control->descripcion.'<br>
