            ...
            <table border="0" cellspacing="0" width="100%" class="fontSize13px mt-20">
                <thead class="border-top border-bottom">
                    <tr>
                        ...
                        <th width="41%">NOMBRE COMPLETO</th>
                        <th width="12%">SENCILLAS</th>
                        <th width="12%">DOBLES</th>
                        <th width="12%">NOCTURNAS</th>
                    </tr>
                </thead>
                <tbody>
                    <tr><td class="fontSize4px" colspan="6">&nbsp;</td></tr>';
                    foreach($data_registros_mensuales as $index => $rm):
                        ...
                        <tr>
                            ...
                            <td>'.number_format(floatval($rm['total_sencillas']), 2, '.', '') .'</td>
                            <td>'.number_format(floatval($rm['total_dobles']), 2, '.', '').'</td>
                            <td>'.number_format(floatval($rm['total_nocturnas']), 2, '.', '').'</td>
                        </tr>';
                    endforeach;
