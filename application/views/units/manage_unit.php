            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                             <a href="<?php echo base_url('Cunit/unit_downloadpdf')?>" class="btn btn-warning" style="color:#fff">Pdf</a> 
                        </div>
                    </div>
             ...
             <?php if($this->permission1->method('manage_unit','update')->access()){ ?>
              ...
              <?php if($this->permission1->method('manage_unit','delete')->access()){ ?>
                                        <a href="" class="DeleteUnit btn btn-danger btn-sm" name="{unit_id}" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         <?php }?>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
...
//            alert("Yes");
              $.ajax({
                  type : "POST",
                  url : '<?php echo base_url('Cunit/unit_delete'); ?>/'+unit_id,
                  cache : false,
                  success : function (r){
                      alert(r);
                  }
