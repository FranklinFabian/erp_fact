                        ...
                        foreach ($quotation_list as $quotation) {
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <?php
                                        ...
                                        echo date('m-d-Y', strtotime($quotation->expire_date));
                                   
                                    ?>
                                </td>
                                <td class="text-right">
                                    <?php echo (($position == 0) ? "$currency $quotation->item_total_amount" : "$quotation->item_total_amount $currency"); ?>
                                </td>
                                 <td class="text-right">
                                    <?php echo (($position == 0) ? "$currency $quotation->service_total_amount" : "$quotation->service_total_amount $currency"); ?>
                                </td>
                                <td><?php
                                ...
                                <td class="text-center">
                                        ...
                                        <a href="<?php echo base_url() . 'Cquotation/quotation_details_data/' . $quotation->quotation_id; ?>" class="btn btn-info btn-sm"   title="<?php echo 'details' ?>" data-original-title="<?php echo 'details' ?> " style="padding: 3px;"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                       
                                        <?php if($this->permission1->method('manage_quotation','delete')->access()){ ?>
                                        <a href="<?php echo base_url() . 'Cquotation/delete_quotation/' . $quotation->quotation_id; ?>" class="btn btn-danger btn-sm"  onclick="return confirm('Are You Sure To Want to Delete ??')" title="<?php echo display('delete') ?>" data-original-title="<?php echo display('delete') ?> " style="padding: 3px;"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
                           
                                    <a href="<?php echo base_url('Cquotation/quotation_download/' . $quotation->quotation_id); ?>" class="btn btn-primary btn-sm"  title="<?php echo display('download') ?>" data-original-title="<?php echo display('download') ?> " style="padding: 3px;"><i class="fa fa-download" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php
