            ...
            <div class="panel panel-bd lobidrag">
               ...
               <div class="panel-heading">
                  ...
                  <div class="panel-title">
                     ...
                     <h4><?php echo "Libro de Ventas IVA" ?></h4>
                  </div>
               </div>
                        ...
                        <div class="panel panel-info">
                           <div class="panel-body text-center">
                              ...
                              <div class="form-group col-md-12 text-center">
                                 <button id="btnGenerarLibroVentasIvaPdf" class="btn btn-primary btn-rounded mb-4"><i class="fa fa-file-pdf-o"></i> Generar Libro de Ventas IVA</button>
                                 <button id="btnGenerarLibroVentasIvaExcel" class="btn btn-success btn-rounded mb-4"><i class="fa fa-file-excel-o"></i> Generar Libro de Ventas IVA</button>
                              </div>
                           </div>
                        </div>
                     </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      ...
      function validarFormulario(){
		...
		$('#btnGenerarLibroVentasIvaPdf').on('click', function () {
         if(validarFormulario()){
            $.ajax({
               type: "POST",
               dataType: 'text',
               url: "<?php echo base_url('cofi/llamarGenerarLibroVentasIva'); ?>",
      ...
      $('#btnGenerarLibroVentasIvaExcel').on('click', function () {
         if(validarFormulario()){
            $.ajax({
               type: "POST",
               dataType: 'text',
