                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4>Administración de Liberaciones</h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function loadModal(id , type){
        $.get( base_url + '/adquisiciones/Cliberacion/modal_edit/?id=' + id + '&type=' + type , function (data) {
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/adquisiciones/Cliberacion/delete/',
            type: 'POST',
            data: {id:id},
    ...
    var snippet_datatable = function () {
        ...
        var initTable1 = function() {
            ...
            table = $('#dataTables').DataTable({
                ...
                serverSide: true,
                ajax:{
                    url :  base_url+'/adquisiciones/Cliberacion/dataList/',
                    type : 'POST',
                },
