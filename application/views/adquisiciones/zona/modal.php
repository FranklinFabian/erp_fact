<form action="<?php echo site_url('adquisiciones/Czona/update');?>" id="form" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <select id="id_localidad" name="item[id_localidad]" class="form-control select2_general" style="width: 100%; display: block;z-index: 9999;margin-top: 100px;" required>
                                    <option></option>
