<form action="<?php echo site_url('adquisiciones/Cgestion/update');?>" id="form" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="gestion" name="item[gestion]" class="form-control" placeholder="Ingrese la descripción" value="<?php if ( $type == 'update') { echo $item['gestion']; }?>">
                            </div>
                        </div>
