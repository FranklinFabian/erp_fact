...
<script type="text/javascript">
    ...
    function loadModal(id , type){
        $.get( base_url + '/adquisiciones/Ccliente/modal_edit/?id=' + id + '&type=' + type , function (data) {
    ...
    function itemDeleteAction(id){
        $.ajax({
            url : base_url+'/adquisiciones/Ccliente/delete/',
            type: 'POST',
            data: {id:id},
    ...
    var snippet_datatable = function () {
        ...
        var initTable1 = function() {
            ...
            table = $('#dataTables').DataTable({
                ...
                serverSide: true,
                ajax:{
                    url :  base_url+'/adquisiciones/Ccliente/dataList/',
                    type : 'POST',
                },
                ...
                columns: [
                    ...
                    { data: 'numero_doc', title: 'Número Documento' },
                    { data: 'nacimiento', title: 'Nacimiento' },
