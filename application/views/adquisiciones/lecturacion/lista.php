...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1> Administrar Lecturación </h1>
            <small> Administra tu Lecturación </small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> Hogar </a></li>
                <li><a href="#"> Lecturación</a></li>
                <li class="active"> Administra tu Lecturación </li>
            </ol>
        </div>
    </section>
...
<script type="text/javascript">
    ...
    var snippet_datatable = function () {
        var initTable1 = function() {
            table = $('#dataTable').DataTable({
                ...
                responsive: true,
                ajax:{
                    url :  base_url+'/adquisiciones/Clecturacion/dataList/',
                    type : 'POST'
                },
                ...
                columns: [
                    { data: 'id', title: 'Id' },
                    { data: 'id', title: 'Codigo Abonado' },
                    { data: 'cid', title: 'Codigo Cliente' },
                    { data: 'razon_social', title: 'Nombre Cliente' },
    ...
    function itemDeleteAction(id){
        $.ajax({
            //url : base_url+'/Cma_orden_compra/deletePadre/',
            url : base_url+'/adquisiciones/Clecturacion/deletePadre/',
            type: 'POST',
            data: {id:id},
