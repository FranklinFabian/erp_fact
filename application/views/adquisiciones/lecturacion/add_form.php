...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Añadir nueva orden de compra</small>
            <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
<?php if($this->permission1->method('administrar_almacen_orden_compra','read')->access()){ ?>
                    <a href="<?php echo base_url('Cma_orden_compra/administrar') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  Administrar las ordenes de compra </a>
                     <?php }?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cma_orden_compra/insert', array('class' => 'form-vertical', 'id' => 'insert', 'name' => 'insert')) ?>
