...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo 'Configuraciones' ?></h1>
            <small><?php echo 'Actualizar Logos' ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('web_settings') ?></a></li>
                <li class="active"><?php echo 'Actualizar Logos' ?></li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo 'Actualizar Logos' ?> </h4>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="currency" id="currency" tabindex="5">
                                    ...
                                    <option value="<?php echo $clist->icon?>" <?php if ($currency == $clist->icon) {
                                            echo "selected";
                                        } ?>><?php echo $clist->currency_name.' '.$clist->icon;?>
                                    </option>
                                    <?php }?>
                                </select>
                            </div>
...
?>
    ...
    echo "selected";
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit"  id="add-customer" class="btn btn-success btn-large" name="add-customer" value="Guardar cambios" tabindex="13"/>
                            </div>
                        </div>
                    </div>
<?php echo form_close() ?>
