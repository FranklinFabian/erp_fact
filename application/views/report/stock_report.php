                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div style="margin-left:2px;">
                            ...
                            <div class="table-responsive" style="margin-top: 10px;" id="printableArea">
...
$(document).ready(function() { 
    ...
    $('#checkList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, "<?php echo $totalnumber;?>"], [10, 25, 50,100,250,500, "All"]],
            ...
            , {
                extend: "pdf", title: "<?php echo $company_info[0]['company_name']?>\n<?php echo $company_info[0]['address']?>\n Stock List", className: "btn-sm prints"
            }
            , {
                extend: "print",title: "<center><?php echo $company_info[0]['company_name']?>\n<br><?php echo $company_info[0]['address']?>\n<br> Stock List</center>", className: "btn-sm prints"
            }
            ],
