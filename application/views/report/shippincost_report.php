                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if ($sales_report) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><?php
                                                 if($position == 0){
                                              echo $currency.' '.$sales['shipping_cost'];  
                                            }else{
                                            echo $sales['shipping_cost'].$currency; 
                                            }
                                     ...
                                     <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align: right;"><b><?php echo display('total') ?></b></td>
                                            <td style="text-align: right;"><b><?php echo (($position == 0) ? "$currency $total_shipping_cost" : "$total_shipping_cost $currency") ?></b></td>
