                            ...
                            <div class="row" style="border-bottom:1px solid #ccc;">
                                ...
                                <div class="col-sm-12">
                                	...
                                	<table>
                                        ...
                                        <strong style="font-size: 30px; "><?php echo (!empty($company[0]['company_name'])?$company[0]['company_name']:'Bdtask Ltd')?></strong><br>
                                        <?php echo (!empty($company[0]['address'])?$company[0]['address']:'Demo Address')?><br>
                                       <span style="font-weight: bold;"> Salary Slip - <?= $paymentdata[0]['salary_month']?></span>
                        		...
                        		<tr>
                                    ...
                                    <?php }?>
                                        ...
                                        <tr class="entry nti">
                                            ...
                                            <td class="value" style="font-weight: bold"><?php echo number_format($totalAddition+$basicsal,2); ?></td>
                                        </tr>
...
<!--                                    <tfoot>
                                ...
                                <?php }?>
                                         ...
                                         <tr class="entry nti">
                                            ...
                                            <td class="value" style="font-weight: bold"><?php echo number_format($totalDeduction+(!empty($totaltax)?$totaltax:0),2); ?></td>
                                        </tr>
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-sm-12" style="padding-bottom: 50px;">
                                        ...
                                        <div class="col-sm-6" style="float:left;font-weight: bold;"><?= display('ref_number')?>: .........</div>
