<div class="content-wrapper">
    ...
    <?php if($this->permission1->method('manage_employee','delete')->access()){ ?>                                
                                        <a href="" class="DeleteEmployee btn btn-danger btn-sm" name="<?php echo $employees['id']?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         <?php }?>
