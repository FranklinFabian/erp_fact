            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input name="first_name" class="form-control" type="text" placeholder="<?php echo display('first_name') ?>" id="first_name" value="<?php echo $employee_data->first_name?>">
                            <input type="hidden" name="id" value="<?php echo $employee_data->id;?>">
                            <input type="hidden" name="old_first_name" value="<?php echo $employee_data->first_name?>">
                        </div>
                         <label for="last_name" class="col-sm-2 col-form-div"><?php echo display('last_name') ?><i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                            <input name="last_name" class="form-control" type="text" placeholder="<?php echo display('last_name') ?>" id="last_name" value="<?php echo $employee_data->last_name?>">
                             <input type="hidden" name="old_last_name" value="<?php echo $employee_data->last_name?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="designation" class="col-sm-2 col-form-div"><?php echo display('designation') ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                            <?php echo form_dropdown('designation',$desig,$employee_data->designation,'class="form-control" style="width:100%"') ?>
                        </div>
                         <label for="phone" class="col-sm-2 col-form-div"><?php echo display('phone') ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                            <input name="phone" class="form-control" type="text" placeholder="<?php echo display('phone') ?>" id="phone" value="<?php echo $employee_data->phone?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <select name="rate_type" class="form-control">
                              ...
                              <option value="1" <?php if($employee_data->rate_type==1){echo 'selected';}?>><?php echo display('hourly')?></option>
                              <option value="2"  <?php if($employee_data->rate_type==2){echo 'selected';}?>><?php echo display('salary')?></option>
                          </select>
                        </div>
                         <label for="hour_rate_or_salary" class="col-sm-2 col-form-div"><?php echo display('hour_rate_or_salary') ?> </label>
                        <div class="col-sm-4">
                            <input name="hrate" class="form-control" type="text" placeholder="<?php echo display('hour_rate_or_salary') ?>" id="hrate" value="<?php echo $employee_data->hrate?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input name="email" class="form-control" type="email" placeholder="<?php echo display('email') ?>" id="email" value="<?php echo $employee_data->email?>">
                        </div>
                         <label for="blood_group" class="col-sm-2 col-form-div"><?php echo display('blood_group') ?> </label>
                        <div class="col-sm-4">
                            <input name="blood_group" class="form-control" type="text" placeholder="<?php echo display('blood_group') ?>" id="blood_group" value="<?php echo $employee_data->blood_group?>">
                        </div>
                    ...
                    <label for="address_line_1" class="col-sm-2 col-form-div"><?php echo display('address_line_1') ?></label>
                        <div class="col-sm-4">
                           <textarea name="address_line_1" class="form-control" placeholder="<?php echo display('address_line_1') ?>" id="address_line_1"><?php echo $employee_data->address_line_1?></textarea> 
                        </div>
                       <label for="address_line_2" class="col-sm-2 col-form-div"><?php echo display('address_line_2') ?></label>
                        <div class="col-sm-4">
                           <textarea name="address_line_2" class="form-control" placeholder="<?php echo display('address_line_2') ?>" id="address_line_2"><?php echo $employee_data->address_line_2?></textarea> 
                        </div>
                    ...
                    <label for="picture" class="col-sm-2 col-form-div"><?php echo display('picture') ?></label>
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="old_image" value="<?php echo $employee_data->image;?>">
                        </div>
               ...
               <option value="<?php echo $employee_data->country;?>" selected><?php echo $employee_data->country;?></option>
                ...
                <div class="form-group row">
                 <label for="city" class="col-sm-2 col-form-div"><?php echo display('city') ?></label>
                        <div class="col-sm-4">
                            <input name="city" class="form-control" type="text" placeholder="<?php echo display('city') ?>" id="city" value="<?php echo $employee_data->city;?>">
                            
                        </div>
                     <label for="zip" class="col-sm-2 col-form-div"><?php echo display('zip') ?></label>
                        <div class="col-sm-4">
                            <input name="zip" class="form-control" type="text" placeholder="<?php echo display('zip') ?>" id="zip" value="<?php echo $employee_data->zip;?>">
                        </div>
                 </div>
