<!-- Manage attendance Start -->
 <link href="<?php echo base_url() ?>assets/dist/timepicker/wickedpicker.min.css" rel="stylesheet" type="text/css"/>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input name="sign_in" value="<?php echo @$sign_in=$data->sign_in?>" class="form-control " type="text"    id="sign_in">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="text" name="sign_out" value="<?php echo @$sign_out=$data->sign_out ;?>" class="form-control"   id="" > 
    </div>
</div>
...
<!-- Start Modal -->
<script src="<?php echo base_url() ?>assets/dist/timepicker/jquery-3.4.min.js" ></script>
<script src="<?php echo base_url() ?>assets/dist/timepicker/wickedpicker.min.js" ></script>
