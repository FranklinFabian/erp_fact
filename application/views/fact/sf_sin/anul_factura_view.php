          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="nro_peticiones" name="nro_peticiones" type="number" min=0 max=1 placeholder="Ej. 1" value="1" required>
              </div>
            </div>
            <?php endif;?>
            ...
            <div class="pure-u-1 pure-u-md-1-1">
              <div class="pure-control-group">
                ...
                <?php
                  ...
                  echo form_dropdown('id_parametrica_tipo_documento_sector',$data_doc);
                ?>
              </div>
            </div>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"sf_sin/anular_factura/";
