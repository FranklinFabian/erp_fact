<div class="header">
  <span class="titulo_pagina">Sincronizar Parametricas Eventos Significativos</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="nro_peticiones" name="nro_peticiones" type="number" min=0 max=100 placeholder="Ej. 50" required>
              </div>            
            </div>
            <?php endif;?>
          ...
          <div class="pure-g">
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-controls">
                ...
                <button id="btn_guardar" type="submit" class="pure-button button-success">Sincronizar</button>
              </div>
            </div>
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-controls">
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"sf_sin/sincronizar_ParametricaEventosSignificativos/";
