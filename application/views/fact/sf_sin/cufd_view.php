<div class="header">
  <span class="titulo_pagina">Obtención de CUFD</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-controls">
                <label for="">Obtener CUFD:</label>
                <button id="btn_guardar" type="submit" class="pure-button button-success">Obtener CUFD</button>
              </div>
            </div>
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-controls">
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"sf_sin/obtener_cufd/";
