<div class="header">
  <span class="titulo_pagina">Registro de eventos significativos</span>
</div>
<p></p>
<?php $csrf = array('name' => $this->security->get_csrf_token_name(),'hash' => $this->security->get_csrf_hash());?>
  <div class="content">
    ...
    <?php 
      if(is_null($pvs) || is_null($eventos)):
    ?>
    <p>NO EXISTEN PUNTOS DE VENTA O EVENTOS SIGNIFICATIVOS</p>
    <?php else:?>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                <label for="nro_peticiones">Nro de peticiones:</label>
                <input id="nro_peticiones" name="nro_peticiones" type="number" min=0 max=100 placeholder="Ej. 100" required>
              </div>
            </div>
            <?php endif;?>
            ...
            <div class="pure-u-1 pure-u-md-1-1">
              <div class="pure-control-group">
                <label for="usuario">Evento significativo:</label>
                <?php
                  foreach ($eventos as $key2 => $ev) 
                    $data[$ev['id_parametrica_evento_significativo']] = '(cod: '.$ev['codigo_clasificador'].') - '.$ev['descripcion'];
                  echo form_dropdown('id_parametrica_evento_significativo',$data);
                ?>
              </div>
            </div>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"sf_sin/registro_evento_significativo/";
