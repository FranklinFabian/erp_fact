<div class="header">
  <span class="titulo_pagina">emisión de paquetes telecomunicaciones</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="nro_peticiones" name="nro_peticiones" type="number" min=0 max=500 placeholder="Ej. 500" required>
              </div>            
            </div>
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"sf_sin/generar_paquete_xml_22/";
