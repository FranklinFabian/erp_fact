        ...
        <div class="panel panel-bd lobidrag">
          <div class="panel-heading">
            <div class="panel-title">
              <h4>Nuevo Centro de transformación</h4>
            </div>
          </div>
        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. C-1" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="centro" name="centro" type="text" placeholder="Ej. Mi centro" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <?php
                  ...
                  $js='id="idpropiedad"';
                  echo form_dropdown('idpropiedad',$data2,'', $js);
                ?>
              </div>            
            </div></p>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"fact/centro/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"fact/centro/lista";
