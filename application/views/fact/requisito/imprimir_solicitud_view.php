...
<body>
	...
	<table width=100% border=0>
		<tr>
			...
			<td align="center" width=33%>
				<h3>
					SOLICITUD DE SUMINISTRO ELECTRICO
				</h3>
			</td>
...
<div class="redondo">
	...
	<table width=100% border=0 cellspacing=0 cellpadding=2>
		<tr><td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Acometida instalada fachada de vivienda</td> <td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Calado e instalado en pared caja de medidor</td></tr>
		<tr><td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Pilote para medidor y acometida</td> <td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Nuevo medidor</td></tr>
		<tr><td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Puesta a tierra</td> <td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Otros</td></tr>
	</table>
</div>
<br>
...
<div class="redondo">
	...
	<table width=100% border=0 cellspacing=0 cellpadding=2>
		<tr><td width=50%>[&nbsp;&nbsp;&nbsp;&nbsp;] Existen medidores cortados sin uso (Técnico): </td> <td width=50%></td></tr>
