<div class="header">
  <span class="titulo_pagina">Estado - Nuevo</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. E" autofocus required>
              </div>            
            </div>
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="estado" name="estado" type="text" placeholder="Ej. Mi estado" required>
              </div>            
            </div>
  ...
  if($(this).parsley().isValid())
    {
      ...
      $.ajax({
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"estado/lista";
