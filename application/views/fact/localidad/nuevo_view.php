          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
            ...
            <p> <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="localidad" name="localidad" type="text" placeholder="Ej. Mi localidad" required>
              </div>            
            </div></p>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"fact/localidad/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"fact/localidad/lista";
