        ...
        <div class="panel panel-bd lobidrag">
          <div class="panel-heading">
            <div class="panel-title">
              <h4>Editando Puntos de Venta</h4>
            </div>
          </div>
        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo_sucursal" name="codigo_sucursal" type="number" min=0 max=100 value="<?php echo $pv['codigo_sucursal'];?>" placeholder="Ej. 0" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo_punto_venta" name="codigo_punto_venta" type="number" min=0 max=100 value="<?php echo $pv['codigo_punto_venta'];?>" placeholder="Ej. 0" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="descripcion_punto_venta" name="descripcion_punto_venta" type="text" value="<?php echo $pv['descripcion_punto_venta'];?>" placeholder="Ej. PV casa matriz único" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="nombre_punto_venta" name="nombre_punto_venta" type="text" value="<?php echo $pv['nombre_punto_venta'];?>" placeholder="Ej. PV casa matriz" required>
              </div>            
            </div></p>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"fact/punto_venta/guardar_punto_venta/<?php echo $pv['id_punto_venta'];?>";
