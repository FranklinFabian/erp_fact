        ...
        <div class="panel panel-bd lobidrag">
          <div class="panel-heading">
            <div class="panel-title">
              <h4>Nuevo Elementos de Maniobra</h4>
            </div>
          </div>
        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-4">
              <div class="pure-control-group">
                ...
                <input id="tipo_proteccion" name="tipo_proteccion" type="text" placeholder="Ej. tipo proteccion" required>
              </div>            
            </div></p>
            ...
            <p> <div class="pure-u-1 pure-u-md-1-4">
              <div class="pure-control-group">
                ...
                <input id="estado" name="estado" type="text" placeholder="Ej. 1" required>
              </div>            
            </div></p>
            ...
            <p> <div class="pure-u-1 pure-u-md-1-4">
              <div class="pure-control-group">
                ...
                <input id="kva_proteccion" name="kva_proteccion" type="number" placeholder="Ej. 1" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-4">
              <div class="pure-control-group">
                ...
                <input id="kv_proteccion" name="kv_proteccion" type="number" placeholder="Ej. 1" required>
              </div>            
            </div></p>
          ...
          <p> <div class="pure-u-1 pure-u-md-1-2">
              <div class="pure-control-group">
                ...
                <input style="width: 60%;" id="proteccion_sup" name="proteccion_sup" type="text" placeholder="Ej. Protección sup." required>
              </div>            
            </div></p>
            <p> <div class="pure-u-1 pure-u-md-1-2">
              <div class="pure-control-group">
                <label for="direccion">Dirección:</label>
                <input style="width: 60%;" id="direccion" name="direccion" type="text" placeholder="Ej. Dirección" required>
              </div>            
            </div></p>
            ...
            <p> <div class="pure-u-1 pure-u-md-1-2">
              <div class="pure-control-group">
                ...
                <?php
                  ...
                  echo form_dropdown('idzona', $data);
                ?>
              </div>            
            </div></p>
            ...
            <p>  <div class="pure-u-1 pure-u-md-1-2">
              <div class="pure-control-group">
                ...
                <?php
                  ...
                  echo form_dropdown('idalimentador', $data2);
                ?>
              </div>            
            </div></p>
