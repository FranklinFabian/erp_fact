<div class="header">
  <span class="titulo_pagina">Listas electricidad</span>
</div>
<p></p>
<div class="content">
    <div class="pure-g">
      <div class="pure-u-1 pure-u-md-1-3"><p style="margin:5px 20px 5px 20px"><a href="<?php echo base_url();?>lista_corte/nuevo/1" id="btn_nuevo" class="pure-button pure-button-primary" style="width:100%;">Crear</a></p></div>
    ...
    <table style="margin-top: 2em;">
      <caption>LISTAS CREADAS (ELECTRICIDAD)</caption>
      <thead>
        <tr>
          <th>N° Circuito.</th>
