...
<?php $csrf = array('name' => $this->security->get_csrf_token_name(),'hash' => $this->security->get_csrf_hash());?>
  <div class="content">
      ...
      <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url();?>fact/zona/actualizar/<?php echo $zona['idzona']?>" data-parsley-validate>
        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. Z-21" value="<?php echo $zona['codigo'];?>" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="zona" name="zona" type="text" placeholder="Ej. Mi zona" value="<?php echo $zona['zona'];?>" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <?php
                  ...
                  $js='id="idlocalidad"';
                  echo form_dropdown('idlocalidad',$data,$zona['idlocalidad'], $js);
                ?>
              </div>            
            </div></p>
