	...
	<table width=100% border=0>
		<tr>
			...
			<td align="right" width=33%>
				<strong>NRO.: <?php  echo $orden['numero'];?></strong>
...
<div id="contenedor">
    ...
    <table width=100% cellpadding=5>
			<tr><td width=12%><strong>FECHA 1° RA. VISITA: </strong> _________ _________ <strong>Hrs.:</strong>	_________ </td></tr>
			<tr><td width=12%><strong>FECHA CONCLUSIÓN:</strong> _________ _________ <strong>Hrs.:</strong>	_________ </td></tr>
			<tr><td width=12%><strong>Lectura medidor:</strong> ___________ <strong>Nro. medidor:</strong>	_________ </td></tr>
