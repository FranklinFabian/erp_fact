...
<div class="redondo"><br>
	<table width=100% border=0 cellspacing=0 cellpadding=2>
		...
		<tr><td width=12%><strong>ZONA:</strong></td><td width=38%> <?php echo $direccion['zona'];?></td> <td width=12%><strong>DESCRIPCIÓN:</strong></td><td width=38%> <?php echo $abonado['descripcion'];?></td></tr>
...
<div class="redondo">
	<table width=100% border=0 cellspacing=0 cellpadding=8>
		...
		<tr><td width=12%>Realizada la inspección del uso de energía en su domicilio, se ha podido constatar que no utiliza la energía eléctrica en la categoría que actualmente está registrado su medidor, por lo que a partir de la fecha se procederá al cambio a su nueva categoría: <strong><?php echo $ncategoria['categoria']?></strong> </td></tr>
	</table>
</div>
