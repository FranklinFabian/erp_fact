...
<br>
    ...
    <table width=100% cellpadding=6>
		<tr>
			...
			<tr>
				<td width=12% colspan="2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque deserunt non officiis sequi nostrum aperiam quasi autem fuga, quidem, numquam repudiandae ab omnis, voluptas odio. Magni minima deserunt eius provident saepe sint fuga dignissimos veniam nostrum architecto, accusantium neque ipsam id laudantium totam aspernatur harum mollitia iure deleniti suscipit. Voluptatum: <strong><?php echo $ncategoria['categoria']?></strong> </td>
			</tr>
		</table>
