...
<div class="content">
    <div class="pure-g">
      <div class="pure-u-1 pure-u-md-1-3"><p style="margin:5px 20px 5px 20px"><a href="<?php echo base_url();?>orden_servicio/procesar_ordenes" class="pure-button button-secondary" style="width:100%;">Volver atras</a></p></div>
    </div>
    ...
    <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url();?>orden_servicio/ejecutar/<?php echo $orden['idorden'];?>" data-parsley-validate>
