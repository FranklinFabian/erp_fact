...
<div class="header">
  <span class="titulo_pagina">Menu Venta elect.</span>
</div>
...
-->  
  ...
  <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url()?>emision_individual/cargar_abonado" data-parsley-validate>
...
//       var url = BASE_URL+"emision_individual/cargar_abonado/";
//       $.ajax({
//         type: "POST",
//         url: url,
...
//         {
//           if(data=='ok')
//             location.href=BASE_URL+"propiedad/lista";
