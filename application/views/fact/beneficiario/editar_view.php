      ...
      <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url();?>abonado/actualizar/<?php echo $abonado['idabonado'];?>" data-parsley-validate>
        ...
        <fieldset>
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                <label for="idconsumidores">Consumidor:</label>
                <?php
                  foreach ($consumidores as $key => $value) 
                    $data_consumidor[$value['idconsumidores']] = $value['codigo'].' - '.$value['consumidor'];;
                  $js_consumidor='id="idconsumidores"';
                  echo form_dropdown('idconsumidores',$data_consumidor,$abonado['idconsumidores'], $js_consumidor);
                ?>
              </div>            
            </div>
