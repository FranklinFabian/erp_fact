...
<div class="content">
<div class="pure-g">
      <div class="pure-u-1 pure-u-md-1-3"><p style="margin:5px 20px 5px 20px"><a href="<?php echo base_url();?>abonado/nuevo/<?php echo $cliente['id_cliente'];?>" id="btn_nuevo" class="pure-button pure-button-primary" style="width:100%;">Nuevo abono +</a></p></div>
    ...
    <div class="pure-g">
      <div class="pure-u-1 pure-u-md-1-3">
        ...
        <h4><span style="color:#000">NOMBRE: </span><?php echo $cliente['apellidos'].' '.$cliente['nombres']?></h4>
      </div>
    </div>
    <hr>
          ...
          echo '
            <tr>
              ...
              if($this->session->userdata('nivel')=='2')
                echo '<td> <a id="btn_editar" class="button-small pure-button button-warning" href="'.base_url().'abonado/editar/'.$value['idabonado'].'">Editar</button></td>';
