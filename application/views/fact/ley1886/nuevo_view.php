<div class="header">
  <span class="titulo_pagina">ley1886 - Nuevo</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="final" name="final" type="date" required>
              </div>
            </div>
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <select name="vigente" id="vigente" required>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"ley1886/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"ley1886/lista";
