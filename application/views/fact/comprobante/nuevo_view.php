<div class="header">
  <span class="titulo_pagina">Comprobante - Nuevo</span>
</div>
<p></p>
          ...
          <div class="pure-u-1 pure-u-md-1-3">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="abierto" name="abierto" type="text" placeholder="Ej. 1" required>
              </div>            
            </div>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"comprobante/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"comprobante/lista";
