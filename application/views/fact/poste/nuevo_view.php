        ...
        <fieldset>
          ...
          <p> <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="poste" name="poste" type="text" placeholder="Ej. Mi poste" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="distancia" name="distancia" type="number" placeholder="Ej. 12" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="unidades" name="unidades" type="text" placeholder="Ej. m" required>
              </div>            
            </div></p>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"fact/poste/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"fact/poste/lista";
