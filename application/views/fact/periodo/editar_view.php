...
<?php $csrf = array('name' => $this->security->get_csrf_token_name(),'hash' => $this->security->get_csrf_hash());?>
  <div class="content">
      ...
      <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url();?>fact/periodo/actualizar/<?php echo $periodo['idperiodo']?>" data-parsley-validate>
        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="emision" name="emision" type="date" placeholder="Ej. 00/00/2000" value="<?php echo $periodo['emision'];?>" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="vencimiento" name="vencimiento" type="date" placeholder="Ej. 00/00/2000" value="<?php echo $periodo['vencimiento'];?>" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="medicion" name="medicion" type="date" placeholder="Ej. 00/00/2000" value="<?php echo $periodo['medicion'];?>" required>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="semision" name="semision" type="date" placeholder="Ej. 00/00/2000" value="<?php echo $periodo['semision'];?>" required>
              </div>            
            </div></p>
