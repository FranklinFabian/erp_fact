...
<body onload="imprimir()">
                    ...
                    <tr>
                        <td align="center">
                                <?php 
                                    ...
                                    echo '<strong>CASA MATRIZ</strong>';
    ...
    <table width="100%" border=1 cellspacing=0 cellpadding=0>
        ...
        $msjMostrarDetalle.= '
            <tr><td colspan="4"></td><td colspan="2" align="right"><strong>TOTAL Bs</strong></td><td align="right">'.number_format((float)($total_cobrar), 2, ',', '.').'</td></tr>
            ...
            <tr><td colspan="4"></td> <td colspan="2" align="right"><strong>SUB TOTAL A PAGAR Bs</strong></td><td align="right">'.number_format((float)($total_cobrar - $lectura['devolucion']), 2, ',', '.').'</td></tr>
            <tr><td colspan="4"></td> <td colspan="2" align="right">(-) AJUSTES NO SUJETOS A IVA Bs</td><td align="right">0,00</td></tr>
            ...
            <tr><td colspan="4"></td> <td colspan="2" align="right">(-) TASAS Bs</td><td align="right">'.number_format($t_tasas,2,',','.').'</td></tr>
            <tr><td colspan="4"></td> <td colspan="2" align="right">(-) OTROS PAGOS NO SUJETOS A IVA Bs</td><td align="right">'.number_format($lectura['afcoop']+$lectura['recargo'],2,',',',').'</td></tr>
            <tr><td colspan="4"></td> <td colspan="2" align="right">(+) AJUSTES NO SUJETOS A IVA Bs</td><td align="right">0,00</td></tr>
