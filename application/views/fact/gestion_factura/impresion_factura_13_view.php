...
<!--                    <tr>
            ...
            <td width=35% class="" style="text-align:center">
                ...
                <table width=100% border=0 cellspacing=0 cellpadding=2>
                    ...
                    <tr>                        
                        <td style="width: 50%; text-align:left"><strong>CÓD. AUTORIZACIÓN:<br>&nbsp;<br>&nbsp;<br>&nbsp;</strong></td> <td style="width: 50%; text-align:left"><?php echo substr($factura['cuf'],0,17).'<br>'.substr($factura['cuf'],17,17).'<br>'.substr($factura['cuf'],34,17).'<br>'.substr($factura['cuf'],51).'<br>';?></td>                        
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table width=100% border=0 cellspacing=0 cellpadding=2>
        ...
        <tr>
            ...
            <td width=50%> <strong>NIT/CI/CEX: </strong>
                <?php
                    $nro_doc = NULL;
        ...
        <tr>
            <td width=50%> <strong>NOMBRE/RAZÓN SOCIAL: </strong>
                <?php
                    if($nro_doc==99002)
...
//        $msjMostrarDetalle.= '<tr><td>1</td><td>1</td><td align=left>UNIDAD (SERVICIOS)</td><td>CONSUMO</td><td align=right>'.number_format($consumo_periodo,2,',','.').'</td><td align=right>'.number_format($lectura['devolucion'], 2, ',','.').'</td><td align=right>'.number_format($consumo_periodo-$lectura['imp_poten']-$lectura['imp_penal'] ,2,',','.').'</td>';
