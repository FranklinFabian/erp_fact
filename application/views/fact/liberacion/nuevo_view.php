<div class="header">
  <span class="titulo_pagina">liberación - Nuevo</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="liberacion" name="liberacion" type="text" placeholder="Ej. Mi liberacion" required>
              </div>            
            </div>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"liberacion/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"liberacion/lista";
