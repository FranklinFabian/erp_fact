        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. Mi codigo" required autofocus>
              </div>            
            </div></p>
            ...
            <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="tipo" name="tipo" type="text" placeholder="Ej. Mi tipo" required autofocus>
              </div>            
            </div></p>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"fact/tipo/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href= BASE_URL+"fact/tipo/lista";
