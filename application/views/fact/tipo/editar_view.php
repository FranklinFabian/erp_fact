...
<?php $csrf = array('name' => $this->security->get_csrf_token_name(),'hash' => $this->security->get_csrf_hash());?>
            <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url()?>fact/tipo/actualizar/<?php echo $tipo['idtipo']?>" data-parsley-validate>
      ...
      <fieldset>
        ...
        <p> <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. Mi codigo" value="<?php echo $tipo['codigo']?>"required>
              </div>            
            </div></p>           
            <p> <div class="pure-u-1 pure-u-md-1-3">
            <div class="pure-control-group">
              <label for="tipo">Tipo:</label>
              <input id="tipo" name="tipo" type="text" placeholder="Ej. Mi tipo" value="<?php echo $tipo['tipo']?>"required>
            </div>            
          </div></p>
