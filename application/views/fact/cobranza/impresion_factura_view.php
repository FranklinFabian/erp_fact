...
//        $msjMostrarDetalle.= '<tr><td>1</td><td>1</td><td align=left>UNIDAD (SERVICIOS)</td><td>CONSUMO</td><td align="right">'.number_format(($consumo_periodo - $lectura['ley1886'] - $lectura['dignidad']),2,',','.').'</td><td align="right">'.number_format($lectura['devolucion'], 2, ',','.').'</td><td align="right">'.number_format(($consumo_periodo-$lectura['imp_poten']-$lectura['imp_penal'] - $lectura['ley1886'] - $lectura['dignidad']) ,2,',','.').'</td>';
