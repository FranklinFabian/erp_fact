          ...
          <p>
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="control" name="control" type="text" placeholder="Ej. Mi control" required autofocus>
                </div>            
            </div>
          </div>
          </p>
...
$('#form_nuevo').submit(function(e) {
  ...
  if ($(this).parsley().isValid()) {
    ...
    const url = BASE_URL+ "fact/control/crear";
    $.ajax({
      type: "POST",
      url: url,
      ...
      {
        if (data == 'ok') {
          location.href = BASE_URL+"fact/control/lista";
        }
        else {
