...
<div class="header">
  <span class="titulo_pagina">Entrega ordenes de servicio</span>
</div>
<p></p>
<div class="content">
    <div class="pure-g">
      <div class="pure-u-1 pure-u-md-1-3"><p style="margin:5px 20px 5px 20px"><a href="<?php echo base_url();?>entrega_devolucion/entrega_orden_servicio" id="btn_nuevo" class="pure-button pure-button-primary" style="width:100%;">Energia electrica</a></p></div>
      <div class="pure-u-1 pure-u-md-1-3"><p style="margin:5px 20px 5px 20px"><a href="<?php echo base_url();?>entrega_devolucion/entrega_orden_servicio_cable" id="btn_nuevo" class="pure-button pure-button-primary" style="width:100%;">TV Cable</a></p></div>
  ...
  <form method="post" class="pure-form pure-form-stacked" id="form_lista" data-parsley-validate>
    ...
    <table style="margin-top: 1em;">
      <thead>
        <caption>LISTA ENERGIA ELECTRICA</caption>
        <tr>
          <th></th>
          <th>N° Orden</th>
          <th>Fecha</th>
      ...
      var selected = '';
        ...
        if(selected != ''){
          ...
          if(confirm("¿Confirmar si desea asignar estos registros al técnico correspondiente?")){
            ...
            $.get( BASE_URL+"entrega_devolucion/asigna_orden_servicio/"+$("#idempleado").val()+"/"+selected, function( data ) {
              console.log(data);
              location.href=BASE_URL+"entrega_devolucion/entrega_orden_servicio";
            });            
          }
