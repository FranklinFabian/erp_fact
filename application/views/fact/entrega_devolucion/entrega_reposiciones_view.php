...
<div class="header">
  <span class="titulo_pagina">Entrega de reposiciones de servicio</span>
</div>
<p></p>
<div class="content">
    <div class="pure-g">
  ...
  <form method="post" class="pure-form pure-form-stacked" id="form_lista" data-parsley-validate>
    ...
    <table style="margin-top: 1em;">
      <thead>
        <caption>LISTA ENTREGA DE REPOSICIONES ENERGIA ELECTRICA</caption>
        <tr>
          <th></th>
          <th>N° Reposición</th>
          <th>Fecha pago</th>
        ...
        if(selected != ''){
          ...
          if(confirm("¿Confirmar si desea asignar estos registros al técnico correspondiente?")){
            ...
            $.get( BASE_URL+"entrega_devolucion/asigna_reposicion/"+$("#idempleado").val()+"/"+selected, function( data ) {
              //console.log(data);
              location.href=BASE_URL+"entrega_devolucion/entrega_reposiciones";
            });            
          }
