...
<?php $csrf = array('name' => $this->security->get_csrf_token_name(),'hash' => $this->security->get_csrf_hash());?>
            <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url()?>fact/proceso/actualizar/<?php echo $proceso['idproceso']?>" data-parsley-validate>
      ...
      <fieldset>
        ...
        <p><div class="pure-u-1 pure-u-md-1-3">
            <div class="pure-control-group">
              ...
              <input id="proceso" name="proceso" type="text" placeholder="Ej. Mi proceso" value="<?php echo $proceso['proceso']?>"required>
            </div>            
          </div></p>
