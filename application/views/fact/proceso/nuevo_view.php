        ...
        <fieldset>
          ...
          <p><div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="proceso" name="proceso" type="text" placeholder="Ej. Mi proceso" required autofocus>
              </div>            
            </div></p>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"fact/proceso/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"fact/proceso/lista";
