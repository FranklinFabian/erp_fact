<div class="header">
  <span class="titulo_pagina">medición - Editar</span>
</div>
<p></p>
<?php $csrf = array('name' => $this->security->get_csrf_token_name(),'hash' => $this->security->get_csrf_hash());?>
  <div class="content">
    <div class="pure-g">      
      ...
      <form method="post" class="pure-form pure-form-stacked" action="<?php echo base_url()?>medicion/actualizar/<?php echo $medicion['idmedicion']?>" data-parsley-validate>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. E" value="<?php echo $medicion['codigo']?>"required>
              </div>            
            </div>
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="medicion" name="medicion" type="text" placeholder="Ej. Mi medicion" value="<?php echo $medicion['medicion']?>"required>
              </div>            
            </div>
