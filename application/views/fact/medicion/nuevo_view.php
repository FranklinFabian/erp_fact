<div class="header">
  <span class="titulo_pagina">medición - Nuevo</span>
</div>
<p></p>
          ...
          <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="codigo" name="codigo" type="text" placeholder="Ej. ABC" autofocus required>
              </div>            
            </div>
            ...
            <div class="pure-u-1 pure-u-md-1-3">
              <div class="pure-control-group">
                ...
                <input id="medicion" name="medicion" type="text" placeholder="Ej. Mi medicion" required>
              </div>            
            </div>
  ...
  if($(this).parsley().isValid())
    {
      ...
      var url = BASE_URL+"medicion/crear";
      $.ajax({
        type: "POST",
        url: url,
        ...
        {
          if(data=='ok')
            location.href=BASE_URL+"medicion/lista";
